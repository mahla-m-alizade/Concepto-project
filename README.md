 این پروژه با هدف، استفاده از روش‌ها و تکنیک‌های مختلف طراحی رابط کاربری با بهره‌گیری از زبان‌های HTML و CSS می‌باشد و فقط صفحه‌ی اصلی (Main) طراحی شده است.
